...
import worker from "/home/wang/cf-workers-template/.wrangler/tmp/bundle-ueZV3r/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/home/wang/cf-workers-template/node_modules/.pnpm/wrangler@3.41.0_@cloudflare+workers-types@4.20240329.0/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/home/wang/cf-workers-template/.wrangler/tmp/bundle-ueZV3r/middleware-insertion-facade.js";
